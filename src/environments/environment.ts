...
export const APIs = {
  ...
  updateHeaders:environment.nodeApiUrl+'PayrollSetup/filterScreen/headers/update',
  searchHeaders:environment.nodeApiUrl+'PayrollSetup/filterScreen/headers/search',

  //Insurance Setup
  updateInsurance:environment.nodeApiUrl+'PayrollSetup/filterScreen/insuranceUpdate',
